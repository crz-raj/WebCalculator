...
# INSTRUCTIONS
First of all go open the directory and use command 

### `npm install`
so all the dependencies are installed 
the instruction below this is actually coppied from the README.md file created by create-react-app itself. ;)
This is my first project so i have no idea what going on.
